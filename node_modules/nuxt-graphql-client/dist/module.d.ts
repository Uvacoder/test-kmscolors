...
interface GqlConfig<T = GqlClient> {
  /**
...
declare type ModuleOptions = Partial<GqlConfig>;
declare const _default: _nuxt_schema.NuxtModule<GqlConfig<GqlClient<string>>>;
