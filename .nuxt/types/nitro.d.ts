...
declare global {
  ...
  const cachedEventHandler: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useQuery: typeof import('h3')['useQuery']
  const useRawBody: typeof import('h3')['useRawBody']
  const useRuntimeConfig: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useStorage: typeof import('/workspace/kms.colors/node_modules/nitropack/dist/runtime')['useStorage']
